...
final class Fence {
     ...
     */
    static String entry(App app, Set<String> origins) {
     ...
     * a URL.
     */
    static String proposeUrl(String repo, App app, Set<String> origins) {
    ...
    List<String> proposable(App app) {
